...
# Example: Mammography BIRADS Classification
import requests
...
print(f"BIRADS Category: {result['prediction']}")
...
```json
{
  "mcpServers": {
    "breast-cancer": {
      "command": "python",
      "args": ["/home/m-aljasem/projects/ai-projects/breast-cancer/mcp_server.py"],
      "env": {
        "PYTHONPATH": "/home/m-aljasem/projects/ai-projects/breast-cancer"
      }
    }
  }
}
